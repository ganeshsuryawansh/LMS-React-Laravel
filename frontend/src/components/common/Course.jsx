...
const Course = ({ course, customClasses }) => {
    return (
        <div key={course.id} className={customClasses}>
            <div className='card border-0'>
                    ...
                    <div className="meta d-flex py-2">
                        <div className="level">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="text ps-2">{course.level.name ? course.level.name : ''}</div>
                            </div>
                        </div>
                ...
                <div className="card-footer bg-white">
                    <div className="d-flex py-2 justify-content-between align-items-center">
                        ...
                        {
                            course.price == 0 && <div className="price">Free</div>
                        }
